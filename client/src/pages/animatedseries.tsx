...
const subcategoriesData = [
  { name: "Adventure Time", slug: "adventuretime", color: "bg-neon-aqua", code: "ADV" },
  { name: "Beavis and Butthead", slug: "beavisandbutthead", color: "bg-neon-aqua", code: "BAB" },
  { name: "Bob's Burgers", slug: "bobsburgers", color: "bg-neon-aqua", code: "BOB" },
  { name: "Boondocks", slug: "boondocks", color: "bg-neon-aqua", code: "BOD" },
  { name: "Family Guy", slug: "familyguy", color: "bg-neon-aqua", code: "FGY" },
  { name: "Futurama", slug: "futurama", color: "bg-neon-aqua", code: "FUT" },
  { name: "King of the Hill", slug: "kingofthehill", color: "bg-neon-aqua", code: "KOH" },
  { name: "Regular Show", slug: "regularshow", color: "bg-neon-aqua", code: "REG" },
  { name: "Rick and Morty", slug: "rickandmorty", color: "bg-neon-aqua", code: "RAM" },
  { name: "Simpsons", slug: "simpsons", color: "bg-neon-aqua", code: "SIM" },
  { name: "South Park", slug: "southpark", color: "bg-neon-aqua", code: "SPA" },
  { name: "Steven Universe", slug: "stevenuniverse", color: "bg-neon-aqua", code: "STU" }
];
...
export default function AnimatedSeriesPage() {
  ...
  return (
    <div className="min-h-screen bg-perforated text-white font-orbitron flex flex-col items-center p-4 pt-4 landscape:pt-2 pb-16">
      ...
      {/* Animated Series Stickers Grid - each box scrolls horizontally */}
