...
const subcategoriesData = [
  { name: 'Sushi', color: 'bg-neon-aqua', code: 'SUS' },
  { name: 'Pho', color: 'bg-neon-aqua', code: 'PHO' },
  { name: 'Pizza', color: 'bg-neon-aqua', code: 'PIZ' },
  { name: 'Burgers', color: 'bg-neon-aqua', code: 'BUR' },
  { name: 'Sweets', color: 'bg-neon-aqua', code: 'SWE' },
  { name: 'Coffee', color: 'bg-neon-aqua', code: 'COF' },
  { name: 'Boba', color: 'bg-neon-aqua', code: 'BOB' },
];
          ...
          <div className="grid grid-cols-1 landscape:grid-cols-2 md:grid-cols-2 md:landscape:grid-cols-4 gap-3 landscape:gap-4 md:gap-5 max-w-lg landscape:max-w-4xl md:max-w-2xl md:landscape:max-w-6xl px-4">
            {subcategories.map((sub, i) => {
              ...
              return (
                <div
                  key={i}
                  className="w-52 h-52 landscape:w-52 landscape:h-52 md:w-56 md:h-56 md:landscape:w-56 md:landscape:h-56 border-4 neon-border-cyan flex items-center justify-center overflow-hidden"
                >
                  {isLoading ? (
